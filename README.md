...
<!-- For inline playback on GitHub, replace the video link below with the bare attachment URL generated by dragging assets/discord-demo1.mp4 into GitHub's Markdown editor. -->
[Watch the Discord Bot demo](./assets/discord-demo1.mp4)

### AI Discord Bot

Connect AI-generated replies to a Discord bot.

<!-- For inline playback on GitHub, replace the video link below with the bare attachment URL generated by dragging assets/discord-demo2.mp4 into GitHub's Markdown editor. -->
[Watch the AI Discord Bot demo](./assets/discord-demo2.mp4)
...
<!-- For inline playback on GitHub, replace the video link below with the bare attachment URL generated by dragging assets/multi-line-demo.mp4 into GitHub's Markdown editor. -->
[Watch the multiline text demo](./assets/multi-line-demo.mp4)
