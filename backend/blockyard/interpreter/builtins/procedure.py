...
`try_catch` 的 `except BlockyardError` 天然攔不到它。
"""
...
from blockyard.errors import ParamOutOfScopeError, ProcedureReturn, ValidationError
from blockyard.interpreter.engine import Thread
from blockyard.interpreter.registry import command, value
